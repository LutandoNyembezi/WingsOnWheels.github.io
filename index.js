...
$(document).ready(function() {
  ...
  function ToCart(foodNameClicked, foodQuantity, singleFoodAmount) {
    ...
    if (food.length !== 0) {
      ...
      for (var i = 0; i < food.length; i++) {
        let cartTxt = '<div class="row cartContentRow"><div class="col-10"> <p>' + food[i][0] + ' </p> <p class="text-muted-small"><i class="fas fa-money-bill-alt "></i>' + food[i][2] + '</p>  </div>  <div class="col-2">  <span class="cartQuantity">' + food[i][1] + '</span> <p class="text-muted-small"><i class="fas fa-money-bill-alt "></i>' + food[i][1] * food[i][2] + '</p>   </div>  </div> <hr class="cartHr">';
